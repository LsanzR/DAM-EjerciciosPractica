...
public class NumeroCapicua {
    ...
    public static int pedirNumero(Scanner input){
        System.out.println("Porfavor introduce un numero entre 0 y 9999 para saber si es capicua");
    ...
    public static int validarNumero (int numero, Scanner input) {
        while (numero < 0 || numero > 9999) { // Siempre que el numero sea menor a 0 o el numero sea mayor a 9999 lanza error por pantalla y vuelve a solicitar la entrada del numero
